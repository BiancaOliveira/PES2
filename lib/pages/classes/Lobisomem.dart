...
class Lobisomem extends StatefulWidget{
  @override
  State createState() => LobisomemState();
}

class LobisomemState extends State<Lobisomem> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget titleSection = Container(
      ...
      child: Text(
          'Você pertence a classe lobisomem!',
          textAlign: TextAlign.center,
          style: TextStyle(
    ...
    Widget textSection = Container(
      ...
      child: Padding(
        ...
        child: Text(
            'Escolha alguém para matar essa noite?',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 18.0,
              color: Colors.white70,
